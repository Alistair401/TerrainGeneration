...
public class OptimisedTerrainGen : MonoBehaviour
{
    ...
    private Vector3[] PlaneGen(int triColumns, float size)
    {
        ...
        vertices[0].y = Random.value * Amplitude; // Top left
        vertices[matrixDimensions - 1].y = Random.value * Amplitude; // Top right
        vertices[(matrixDimensions - 1) * matrixDimensions].y = Random.value * Amplitude; // Bottom left
        vertices[matrixDimensions * matrixDimensions - 1].y = Random.value * Amplitude; // Bottom right
        ...
        for (int i = 0; i < iterations; i++)
        {
            ...
            for (int j = 0; j < (int) Mathf.Pow(4, i); j++)
            {
                ...
                // Sample the diamond
                float ul = vertices[minSampleCorner].y;
                float ur = vertices[minSampleCorner + sampleDimensions - 1].y;
                float bl = vertices[minSampleCorner + (sampleDimensions - 1) * matrixDimensions].y;
                float br = vertices[minSampleCorner + sampleDimensions - 1 + (sampleDimensions - 1) * matrixDimensions]
                    .y;
                ...
                if (row != 0)
                {
                    vertices[midN[0]].y = val;
                    vertices[midN[1]].y = val;
                }
                vertices[midN[2]].y = val;
                vertices[midN[3]].y = val;
                ...
                {
                    vertices[midE[1]].y = val;
                    vertices[midE[3]].y = val;
                }
                vertices[midE[0]].y = val;
                vertices[midE[2]].y = val;
                ...
                if (maxSampleCorner < matrixDimensions * (matrixDimensions - 1))
                {
                    vertices[midS[2]].y = val;
                    vertices[midS[3]].y = val;
                }
                vertices[midS[0]].y = val;
                vertices[midS[1]].y = val;
                ...
                {
                    vertices[midW[0]].y = val;
                    vertices[midW[2]].y = val;
                }
                vertices[midW[1]].y = val;
                vertices[midW[3]].y = val;
    ...
    private static int[] GetDuplicateVertices(int upperLeftIndex, int matrixDimensions)
    {
